                ...
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <a href="index.html" class="logo">
                            <img src="{{ asset('fontend/assets/images/logo.png') }}">
                        </a>
                        <!-- ***** Logo End ***** -->
                        <!-- ***** Menu Start ***** -->
                        <ul class="nav">
                        ...
                        <div class="owl-men-item owl-carousel">
                            <div class="item">
                                <div class="thumb">
                                    ...
                                    <img src="{{ asset('fontend/assets/images/men-01.jpg') }}" alt="">
                                </div>
                            ...
                            <div class="item">
                                <div class="thumb">
                                    ...
                                    <img src="{{ asset('fontend/assets/images/men-02.jpg') }}" alt="">
                                </div>
                                <div class="down-content">
                                    <h4>Air Force 1 X</h4>
                                    <span>$90.00</span>
                            ...
                            <div class="item">
                                <div class="thumb">
                                    ...
                                    <img src="{{ asset('fontend/assets/images/men-03.jpg') }}" alt="">
                                </div>
                                <div class="down-content">
                                    <h4>Love Nana ‘20</h4>
                                    <span>$150.00</span>
                        ...
                        <div class="owl-women-item owl-carousel">
                            <div class="item">
                                <div class="thumb">
                                    ...
                                    <img src="{{ asset('fontend/assets/images/women-01.jpg') }}" alt="">
                                </div>
                                <div class="down-content">
                            ...
                            <div class="item">
                                <div class="thumb">
                                    ...
                                    <img src="{{ asset('fontend/assets/images/women-02.jpg') }}" alt="">
                                </div>
                                <div class="down-content">
                                    <h4>Classic Dress</h4>
                                    <span>$45.00</span>
                            ...
                            <div class="item">
                                <div class="thumb">
                                    ...
                                    <img src="{{ asset('fontend/assets/images/women-03.jpg') }}" alt="">
                                </div>
                                <div class="down-content">
                        ...
                        <div class="owl-kid-item owl-carousel">
                            <div class="item">
                                <div class="thumb">
                                    ...
                                    <img src="{{ asset('fontend/assets/images/kid-01.jpg') }}" alt="">
                                </div>
                                <div class="down-content">
                            ...
                            <div class="item">
                                <div class="thumb">
                                    ...
                                    <img src="{{ asset('fontend/assets/images/kid-02.jpg') }}" alt="">
                                </div>
                                <div class="down-content">
                                    <h4>Summer Cap</h4>
                                    <span>$12.00</span>
                            ...
                            <div class="item">
                                <div class="thumb">
                                    ...
                                    <img src="{{ asset('fontend/assets/images/kid-03.jpg') }}" alt="">
                                </div>
                                <div class="down-content">
                                    <h4>Classic Kid</h4>
                                    <span>$30.00</span>
            ...
            <div class="row images">
                <div class="col-2">
                    <div class="thumb">
                        ...
                        <img src="{{ asset('fontend/assets/images/instagram-01.jpg') }}" alt="">
                    </div>
                </div>
                <div class="col-2">
                    <div class="thumb">
                        ...
                        <img src="{{ asset('fontend/assets/images/instagram-02.jpg') }}" alt="">
                    </div>
                </div>
                <div class="col-2">
                    <div class="thumb">
                        ...
                        <img src="{{ asset('fontend/assets/images/instagram-03.jpg') }}" alt="">
                    </div>
                </div>
                <div class="col-2">
                    <div class="thumb">
                        ...
                        <img src="{{ asset('fontend/assets/images/instagram-04.jpg') }}" alt="">
                    </div>
                </div>
                <div class="col-2">
                    <div class="thumb">
                        ...
                        <img src="{{ asset('fontend/assets/images/instagram-05.jpg')}}" alt="">
                    </div>
                </div>
                <div class="col-2">
                    <div class="thumb">
                        ...
                        <img src="{{ asset('fontend/assets/images/instagram-06.jpg')}}" alt="">
                    </div>
                </div>
            </div>
        </div>
